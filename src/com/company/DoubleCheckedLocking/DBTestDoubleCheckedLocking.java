package com.company.DoubleCheckedLocking;
...
public class DBTestDoubleCheckedLocking {
    ...
    public static void main(String[] args) {
        ...
        Database3 db = Database3.getInstance("jdbc:postgresql://localhost:5432/postgres",
                "postgres",
                "postgres");

        Database3 dbTest = Database3.getInstance("jdbc:postgresql://localhost:5432/postgres",
                "postgres",
                "postgres");
