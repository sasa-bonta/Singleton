package com.company.Lab1.Synchronized;

import java.sql.ResultSet;
import java.sql.SQLException;
import java.sql.Statement;

public class DBTestSynchronized {
    ...
    public static void main(String[] args) {
        ...
        Database2 db = Database2.getInstance("jdbc:postgresql://localhost:5432/postgres",
                "postgres",
                "postgres");

        Database2 dbTest = Database2.getInstance("jdbc:postgresql://localhost:5432/postgres",
                "postgres",
                "postgres");
